function u_opt = FHCOP(xk, Q, R, N, x_bar, u_bar, tau_s)
    ...
    u = opti.variable(1, N);  %vettore di una 1 riga e N colonne 
    x = opti.variable(2, N+1); %2 righe perchè abbiamo due stati
    %in questo caso minizziamo J rispetto anche gli stati
